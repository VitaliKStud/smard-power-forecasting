---
title: "Case Study"
# abstract: "empty abstract (only an Exerciece)"
# keywords: "Statistics, Regression, Forecasting"

course: Prädiktive Analytik (Prof. Dr. Buchwitz)
...
- familyname: Krilov
  ...
  qualifications: "Data Science (MA, 4. Semester)"
...
# Deutsche Feiertage laden für die Jahre 2015 - 2024 und in ein DataFrame bringen.
...
load_german_holidays <- function(from_year, to_year) {
  ...
  for (year in from_year:to_year) {
    ...
    holidays <- lapply(res, `[`, c("date", "localName", "name", "fixed", "global")) |>
      bind_rows() |>
  ...
  holiday_to_filter <- as.Date(all_holidays_df$date)
  
  return(holiday_to_filter)
